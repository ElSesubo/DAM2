...
public class Model {
	...
	public static String mostrarContenido() {
		String texto = null;
		try(FileReader fileReader = new FileReader("C:/Users/gaarag/Documents/DAM 2º/AD/HolaMundo/src/es/florida/ejT1/ej2_9/document.txt")){
	...
	public static void reemplazarPalabra(File archivo, String palabra, String reemplazo) {
		try {
			if(archivo.exists()) {
				BufferedReader leerArchivo = new BufferedReader(new FileReader(archivo));
                String lineaLeida;
